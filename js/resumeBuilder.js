...
var education = {"schools":[
    {"name":"International Training Organization", "location":"Hollywood, CA, USA", "degree":"Business Analysis &amp; Program Execution", "majors":"Organizational Management", "dates":"1995-2002", "url":""},
    {"name":"Robertsbridge", "location":"Robertsbridge, United Kingdom", "degree":"Full GCSEs", "majors":"", "dates":"1992-1993", "url":"http://www.robertsbridge.org.uk"},
    {"name":"Warden Park", "location":"Haywards Heath, United Kingdom", "degree":"N/A", "majors":"", "dates":"1991-1992", "url":"http://www.wardenpark.co.uk"},
    {"name":"Sackville", "location":"East Grinstead, United Kingdom", "degree":"N/A", "majors":"", "dates":"1991-1991", "url":"http://www.sackville.w-sussex.sch.uk"},
    {"name":"Mace Kingsley", "location":"Passedena, CA, USA", "degree":"N/A", "majors":"", "dates":"1988-1991", "url":""},
    {"name":"Delphi Academy", "location":"Los Angeles, CA, USA", "degree":"N/A", "majors":"", "dates":"1987-1988", "url":"http://www.delphila.org"},
    {"name":"Cave Creek", "location":"Pheonix, AZ, USA", "degree":"N/A", "majors":"", "dates":"1986-1987", "url":"http://www.ccusd93.org/education/district/district.php?sectionid=1"},
				{"name":"Apple School", "location":"Clearwater, FL, USA", "degree":"N/A", "majors":"", "dates":"1983-1986", "url":""}
],
"onlineCourses":[
    {"title":"Front End Web Developer Nanodegree", "school":"Udacity", "dates":"2016-Current", "url":"https://www.udacity.com/course/front-end-web-developer-nanodegree--nd001"},
    {"title":"Intro to Programming Nanodegree", "school":"Udacity", "dates":"2014-2015", "url":"https://www.udacity.com/nanodegrees-new-s/nd000"}
],
display: function() {
    ...
    if (onlineCs.length > 0) {
        ...
        for (var i=0;i<onlineCs.length;i++) {
            ...
            var onlineTitle = HTMLonlineTitle.replace("%data%",online.title) + HTMLonlineSchool.replace("%data%",online.school);
            $('#education').append(HTMLschoolStart);
...
var work = {"jobs":[
    ...
    {"employer":"Jaager Fashion", "title":"Factory Worker", "location":"Kent, England", "dates":"1992-1993", "description":"Worked in a factory sewing high-end clothing."}
],
display: function() {
...
var projects = {"projects":[
    {"title":"Scilla Yacht", "dates":"2016", "description":"Web build of Chartered Yacht site", "images":["images/pj1a.jpg", "images/pj1b.jpg"]},
    {"title":"Sensible Shopper", "dates":"2015", "description":"Local Business site", "images":["images/pj2a.jpg", "images/pj2b.jpg"]},
    {"title":"French Coves", "dates":"2016", "description":"New House Development", "images":["images/pj3a.jpg", "images/pj3b.jpg"]}
],
display:function() {
